...
using AccessControl.Controllers.Home;
using AccessControl.Controllers.Manage;
...
using UserIdentity.Models.AccountViewModels;
...
namespace AccessControl.Controllers.Account
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Set User/Admin Role
                    var setRole = _userManager.AddToRoleAsync(user, "User");
                    var setRoleAdmin = _userManager.AddToRoleAsync(user, "Admin");
                    ...
                    return View("ConfirmEmailAddress", new VerifyEmailAddressViewModel() { EmailAddress = model.Email, ReturnUrl = returnUrl});                    
                }
                AddErrors(result);
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ConfirmEmail(VerifyEmailAddressViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, user.NormalizedUserName, "Reset Password",
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                await _emailSender.SendEmailAsync(await _userManager.GetEmailAsync(user), user.NormalizedUserName, "Security Code", message);
            }
